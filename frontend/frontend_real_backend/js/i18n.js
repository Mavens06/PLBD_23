...
(function () {
  ...
  const D = {
    fr: {
      ...
      runtimeNote:"Cette version est reliée au robot réel : elle affiche les mesures envoyées par le robot via le backend et les recommandations du modèle ML — aucune simulation.",
      ...
      sugWater:"💧 Mon sol manque-t-il d’eau ?", sugCrop:"🌾 Quelle culture pour mon sol ?", sugZone:"📍 Comprendre le sol en ", sugRobot:"🛠️ Comment améliorer mon sol ?",
      ...
      alreadyWet:"Sol déjà humide", raisePh:"pH à relever", correctPh:"pH à corriger", organicInput:"apport organique", compatibility:"compatibilité", adaptDate:"attendre/adapter date", target:"Cible", betterSuited:"Mieux adapté à ce sol",
      ...
      missionPlanTitle:"Plan de mission", planPoints:"points", planCol:"Point", planAdd:"Ajouter un point", planApply:"Appliquer le plan", planRemove:"Supprimer", planInsert:"Insérer un point ici",
      ...
      planSpacingNote:"Définissez les points de mesure par coordonnées · espacement min. {d} m", planAllowedNote:"valeurs : {vals} m", planTooClose:"{a} et {b} trop proches (min. {d} m d'écart)",
      planQuick:"Plan rapide", planSquare:"Carré (4 points)", choosePoints:"Choisissez vos points de mesure", choosePointsHint:"Cochez les emplacements où le robot doit mesurer.", start:"Départ", planMax:"Maximum {n} points pour cette parcelle.", planDragHint:"Astuce : glissez un point sur la carte pour le déplacer.",
    ...
    ar: {
      ...
      runtimeNote:"هذه النسخة موصولة بالروبوت الحقيقي: تعرض القياسات التي يرسلها الروبوت عبر الخادم وتوصيات نموذج التعلّم الآلي — بدون محاكاة.",
      ...
      sugWater:"💧 هل تربتي تنقصها المياه؟", sugCrop:"🌾 أي محصول يناسب تربتي؟", sugZone:"📍 فهم التربة في ", sugRobot:"🛠️ كيف أحسّن تربتي؟",
      ...
      alreadyWet:"التربة رطبة بالفعل", raisePh:"رفع قيمة pH", correctPh:"تصحيح pH", organicInput:"إضافة عضوية", compatibility:"التوافق", adaptDate:"انتظار/تعديل موعد الزراعة", target:"المجال", betterSuited:"أنسب لهذه التربة",
      ...
      missionPlanTitle:"خطة المهمة", planPoints:"نقاط", planCol:"النقطة", planAdd:"إضافة نقطة", planApply:"تطبيق الخطة", planRemove:"حذف", planInsert:"إدراج نقطة هنا",
      planMin:"مطلوب نقطة قياس واحدة على الأقل.", planInvalid:"أسماء فارغة أو مكررة — صحّح الخطة.", planApplied:"تم تطبيق الخطة: {n} نقطة",
      planSpacingNote:"حدّد نقاط القياس بالإحداثيات · المسافة الدنيا {d} م", planAllowedNote:"القيم: {vals} م", planTooClose:"{a} و {b} متقاربتان جداً (الحد الأدنى {d} م)",
      planQuick:"خطة سريعة", planSquare:"مربّع (4 نقاط)", choosePoints:"اختاروا نقاط القياس", choosePointsHint:"أشّروا على الأماكن التي يقيس فيها الروبوت.", start:"الانطلاق", planMax:"الحد الأقصى {n} نقاط لهذه القطعة.", planDragHint:"نصيحة: اسحب نقطة على الخريطة لتحريكها.",
    ...
    da: {
      ...
      runtimeNote:"هاد النسخة موصولة بالروبو الحقيقي: كتبيّن القياسات اللي كيصيفط الروبو عبر الـbackend وتوصيات الموديل ديال ML — بلا محاكاة.",
      ...
      sugWater:"💧 واش الأرض ديالي ناقصها الما؟", sugCrop:"🌾 أش نزرع فهاد الأرض؟", sugZone:"📍 نفهم التربة فـ ", sugRobot:"🛠️ كيفاش نحسّن الأرض ديالي؟",
      ...
      alreadyWet:"التراب فيه الما كافي", raisePh:"طلع pH", correctPh:"صحح pH", organicInput:"إضافة عضوية", compatibility:"التوافق", adaptDate:"تسنى/بدل وقت الزرع", target:"المجال", betterSuited:"أحسن لهاد التربة",
      ...
      missionPlanTitle:"بلان المهمة", planPoints:"نقط", planCol:"النقطة", planAdd:"زيد نقطة", planApply:"طبق البلان", planRemove:"حيد", planInsert:"دخّل نقطة هنا",
      planMin:"خاص على الأقل نقطة قياس وحدة.", planInvalid:"أسماء خاوية ولا مكررة — صحح البلان.", planApplied:"تطبق البلان: {n} نقطة",
      planSpacingNote:"حدد نقط القياس بالكوردوني · المسافة الصغيرة {d} م", planAllowedNote:"القيم: {vals} م", planTooClose:"{a} و {b} قراب بزاف (خاص {d} م على الأقل)",
      planQuick:"بلان سريع", planSquare:"مربّع (4 نقط)", choosePoints:"ختار نقط القياس ديالك", choosePointsHint:"شيك على البلايص فين خاص الروبو يقيس.", start:"البداية", planMax:"الماكسيموم {n} نقط لهاد القطعة.", planDragHint:"نصيحة: جر نقطة فالخريطة باش تحركها.",
  ...
  window.trStatus = function (status) {
    ...
    // Version RÉELLE : au repos = « En attente » (pas de vocabulaire « simulation »).
    if (/Simulation prête|En attente|Mission prête/.test(s)) return t("missionReady");
