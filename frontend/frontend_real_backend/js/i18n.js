...
(function () {
  ...
  const D = {
    fr: {
      ...
      planQuick:"Plans rapides", start:"Départ", planMax:"Maximum {n} points pour cette parcelle.", planDragHint:"Astuce : glissez un point sur la carte pour le déplacer.",
    ...
    ar: {
      ...
      planQuick:"خطط سريعة", start:"الانطلاق", planMax:"الحد الأقصى {n} نقاط لهذه القطعة.", planDragHint:"نصيحة: اسحب نقطة على الخريطة لتحريكها.",
    ...
    da: {
      ...
      planQuick:"بلانات سريعة", start:"البداية", planMax:"الماكسيموم {n} نقط لهاد القطعة.", planDragHint:"نصيحة: جر نقطة فالخريطة باش تحركها.",
