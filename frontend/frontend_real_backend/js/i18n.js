...
(function () {
  ...
  const D = {
    fr: {
      ...
      planQuick:"Plan rapide", planSquare:"Carré (4 points)", start:"Départ", planMax:"Maximum {n} points pour cette parcelle.", planDragHint:"Astuce : glissez un point sur la carte pour le déplacer.",
    ...
    ar: {
      ...
      planQuick:"خطة سريعة", planSquare:"مربّع (4 نقاط)", start:"الانطلاق", planMax:"الحد الأقصى {n} نقاط لهذه القطعة.", planDragHint:"نصيحة: اسحب نقطة على الخريطة لتحريكها.",
    ...
    da: {
      ...
      planQuick:"بلان سريع", planSquare:"مربّع (4 نقط)", start:"البداية", planMax:"الماكسيموم {n} نقط لهاد القطعة.", planDragHint:"نصيحة: جر نقطة فالخريطة باش تحركها.",
